...
import { computed, onBeforeUnmount, onMounted, ref, toRefs } from 'vue-demi';
...
import { isValidTimeout } from '@/utils/validator';
import {
  useTicker,
  useTimer,
} from '@/utils/timer';

import type { VnNotificationProps as Props } from '@/types/options';

type UseTickerReturnType = ReturnType<typeof useTicker>;
